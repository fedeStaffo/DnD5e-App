...
public final class ActivityVisualizzaPersonaggioBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityVisualizzaPersonaggioBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityVisualizzaPersonaggioBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_visualizza_personaggio, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityVisualizzaPersonaggioBinding bind(@NonNull View rootView) {
