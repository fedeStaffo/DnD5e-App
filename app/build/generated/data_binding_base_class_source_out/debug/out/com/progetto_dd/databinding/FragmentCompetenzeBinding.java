...
public final class FragmentCompetenzeBinding implements ViewBinding {
  ...
  public static FragmentCompetenzeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_competenze, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCompetenzeBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.recyclerViewCompetenze;
      RecyclerView recyclerViewCompetenze = ViewBindings.findChildViewById(rootView, id);
      if (recyclerViewCompetenze == null) {
        break missingId;
      }
