...
public abstract interface IncantesimoDao {
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "SELECT * FROM tabella_incantesimi WHERE nome LIKE \'%\' || :keyword || \'%\'")
    public abstract java.lang.Object searchIncantesimiByKeyword(@org.jetbrains.annotations.NotNull()
